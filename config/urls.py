...
urlpatterns = [
    ...
    path('db-management/download/', views.download_db, name='download_db'),
    path('db-management/upload-old/', views.upload_old_db, name='upload_old_db'),
    path('db-management/upload-new/', views.upload_new_db, name='upload_new_db'),
]